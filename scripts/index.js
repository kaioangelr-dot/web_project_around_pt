...
const cardFormValidator = new FormValidator(configSelectors, addCardForm); //prettier-ignore
const profileFormValidator = new FormValidator(configSelectors, editForm); //prettier-ignore
...
editBtn.addEventListener("click", () => {
  ...
  //reset the validation state of the edit profile form by calling the resetValidation method of the profileFormValidator instance, which resets the error messages and disables the submit button until the user starts typing in the input fields again
...
addCardBtn.addEventListener("click", () => {
  ...
  //reset the validation state of the add card form by calling the resetValidation method of the cardFormValidator instance, which resets the error messages and disables the submit button until the user starts typing in the input fields again
